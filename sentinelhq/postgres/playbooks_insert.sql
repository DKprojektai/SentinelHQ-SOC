...
('OTX_BAD_DESTINATION',    'Ryšys su OTX žvalgyboje pažymėtu IP/domenu',                   FALSE, TRUE, 13, 30),
('RARE_DESTINATION',       'Pirmą kartą matomas išorinis tinklo adresas',                  FALSE, TRUE,  8, 60),
('IDENTITY_OFFHOURS_LOGON','Prisijungimas ne darbo metu (konfigūruojamas langas)',         FALSE, TRUE,  8, 60),
('IDENTITY_NEW_HOST_LOGON','Vartotojas pirmą kartą jungiasi prie hosto — šoninis judėjimas', FALSE, TRUE,  9, 60),
('IDENTITY_PRIV_ANOMALY',  'Naujas privilegijuotas vartotojas — admin teisės be istorijos', FALSE, TRUE, 10, 30),
